            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 bannerBox">
                        <h1>We Build and Market Online</h1>
                        <div class="bannerPar">
                        <h4>Experience the power of proven online professionals.</h4>
                        </div>
                        
                        <div class="col-xs-12 col-sm-6 col-md-4 ggl-sscrl">
                        
                            <a id="down-mc-btn" class="scroll btn-lg btn-success ggl-sscrl" data-speed="380" data-target="#ourgoogleservices" href="#ourgoogleservices">
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-lg-6 smallHeading newhoverTwo">
                                    ...
                                    <div class="effect">
                                        ...
                                        <p>We're robust in our ecommerce experience and dedicated to your success.</p>
                                            <br />
                                                <!--<a class="box1" href="#">Read More.</a>-->
                                    </div>
                                </div>
                        ...
                        <p class="text-center">Each month we choose a few of our customers to feature. It's our little way of saying THANK YOU to each and every one of you.</p>
                            <div class="row text-center caseLogos">
                                <div class="col-sm-4 smallHeading"> 
                                    <img src="img/folio_sv.jpg" alt="Saint Vincent Hospital">                            
                                </div>
                                <div class="col-sm-4 smallHeading">
